      ...
      <div>
        ...
        <div className="sm:ml-72 sm:pl-4 sm:mt-4 text-gray-700 font-medium">
          ...
          <div className=" overflow-hidden">
            <div
              className="w-full flex items-center  gap-3 mt-4 transition-all ease-in-out  duration-500  "
              style={{ transform: ` translateX(-${current * 10}vw)` }}
            >
              {docSlots.length &&
            ...
            <div className="w-full flex items-center justify-between gap-4 mt-6">
              <button
                ...
                className="text-sm text-white font-light bg-primary  px-14 py-3 rounded-full "
              >
                Book an appointment
              </button>
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="text-3xl text-gray-400 border border-gray-300 hover:bg-primary hover:text-white transition-all p-1 rounded"
                >
                  <MdOutlineArrowBackIosNew />
                </button>
                <button
