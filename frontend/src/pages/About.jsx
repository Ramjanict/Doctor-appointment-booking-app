  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row mb-20">
        <div className="flex flex-col gap-5 border px-10 md:px-16 py-8 md:py-16 text-[15px] text-gray-600 hover:bg-primary hover:text-white transition-all duration-300 cursor-pointer">
          <b>EFFICIENCY:</b>
          <p>
